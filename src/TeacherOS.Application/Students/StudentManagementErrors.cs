...
public static class StudentManagementErrors
{
    ...
    public static Error GuardianNotFound { get; } = new("Students.GuardianNotFound", "The guardian was not found.", ErrorType.NotFound);
    public static Error StudentGuardianNotFound { get; } = new("Students.StudentGuardianNotFound", "The student-guardian link was not found.", ErrorType.NotFound);
    ...
    public static Error StudentGuardianAlreadyLinked { get; } = new("Students.StudentGuardianAlreadyLinked", "The guardian is already linked to this student.", ErrorType.Conflict);
}
